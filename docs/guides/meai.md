...
The Anam SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Anam
```
...
using var client = new AnamClient(
    apiKey: Environment.GetEnvironmentVariable("ANAM_API_KEY")!);
