...
namespace Anam
{
    public partial class KnowledgeClient
    {
        ...
        private static readonly global::Anam.EndPointSecurityRequirement s_ListKnowledgeGroupsSecurityRequirement0 =
        ...
        private static readonly global::Anam.EndPointSecurityRequirement[] s_ListKnowledgeGroupsSecurityRequirements =
            new global::Anam.EndPointSecurityRequirement[]
            {                s_ListKnowledgeGroupsSecurityRequirement0,
            };
        partial void PrepareListKnowledgeGroupsArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareListKnowledgeGroupsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessListKnowledgeGroupsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListKnowledgeGroupsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anam.ListKnowledgeGroupsResponse> ListKnowledgeGroupsAsync(
            global::Anam.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListKnowledgeGroupsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anam.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anam.AutoSDKHttpResponse<global::Anam.ListKnowledgeGroupsResponse>> ListKnowledgeGroupsAsResponseAsync(
            global::Anam.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListKnowledgeGroupsArguments(
                httpClient: HttpClient);


            var __authorizations = global::Anam.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ListKnowledgeGroupsSecurityRequirements,
                operationName: "ListKnowledgeGroupsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListKnowledgeGroupsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anam.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anam.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListKnowledgeGroupsAsync",
                                pathTemplate: "\"/v1/knowledge/groups\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListKnowledgeGroupsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anam.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListKnowledgeGroupsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anam.ListKnowledgeGroupsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anam.AutoSDKHttpResponse<global::Anam.ListKnowledgeGroupsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anam.ListKnowledgeGroupsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
