...
namespace Anam
{
    public partial class SessionsClient
    {
        ...
        private static readonly global::Anam.EndPointSecurityRequirement s_GetSessionTranscriptSecurityRequirement0 =
        ...
        private static readonly global::Anam.EndPointSecurityRequirement[] s_GetSessionTranscriptSecurityRequirements =
            new global::Anam.EndPointSecurityRequirement[]
            {                s_GetSessionTranscriptSecurityRequirement0,
            };
        partial void PrepareGetSessionTranscriptArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id);
        partial void PrepareGetSessionTranscriptRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id);
        partial void ProcessGetSessionTranscriptResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSessionTranscriptResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anam.SessionTranscript> GetSessionTranscriptAsync(
            global::System.Guid id,
            global::Anam.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetSessionTranscriptAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anam.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anam.AutoSDKHttpResponse<global::Anam.SessionTranscript>> GetSessionTranscriptAsResponseAsync(
            global::System.Guid id,
            global::Anam.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSessionTranscriptArguments(
            ...
            var __authorizations = global::Anam.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSessionTranscriptSecurityRequirements,
                operationName: "GetSessionTranscriptAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anam.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anam.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSessionTranscriptAsync",
                                pathTemplate: "$\"/v1/sessions/{id}/transcript\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSessionTranscriptResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anam.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSessionTranscriptResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anam.SessionTranscript.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anam.AutoSDKHttpResponse<global::Anam.SessionTranscript>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anam.SessionTranscript.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
