...
namespace Anam
{
    public partial class KnowledgeClient
    {
        ...
        private static readonly global::Anam.EndPointSecurityRequirement s_UploadKnowledgeGroupDocumentSecurityRequirement0 =
        ...
        private static readonly global::Anam.EndPointSecurityRequirement[] s_UploadKnowledgeGroupDocumentSecurityRequirements =
            new global::Anam.EndPointSecurityRequirement[]
            {                s_UploadKnowledgeGroupDocumentSecurityRequirement0,
            };
        partial void PrepareUploadKnowledgeGroupDocumentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Anam.UploadKnowledgeGroupDocumentRequest request);
        partial void PrepareUploadKnowledgeGroupDocumentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::Anam.UploadKnowledgeGroupDocumentRequest request);
        partial void ProcessUploadKnowledgeGroupDocumentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUploadKnowledgeGroupDocumentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anam.KnowledgeDocument> UploadKnowledgeGroupDocumentAsync(
            string id,
        ...
        {
            var __response = await UploadKnowledgeGroupDocumentAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anam.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anam.AutoSDKHttpResponse<global::Anam.KnowledgeDocument>> UploadKnowledgeGroupDocumentAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUploadKnowledgeGroupDocumentArguments(
            ...
            var __authorizations = global::Anam.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UploadKnowledgeGroupDocumentSecurityRequirements,
                operationName: "UploadKnowledgeGroupDocumentAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anam.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anam.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UploadKnowledgeGroupDocumentAsync",
                                pathTemplate: "$\"/v1/knowledge/groups/{id}/documents\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Anam.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Anam.ApiException.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUploadKnowledgeGroupDocumentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anam.KnowledgeDocument.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anam.AutoSDKHttpResponse<global::Anam.KnowledgeDocument>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anam.KnowledgeDocument.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Anam.KnowledgeDocument> UploadKnowledgeGroupDocumentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anam.UploadKnowledgeGroupDocumentRequest
            {
                File = file,
                Filename = filename,
                ChunkSize = chunkSize,
            ...
            return await UploadKnowledgeGroupDocumentAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Anam.UploadKnowledgeGroupDocumentRequest
            {
