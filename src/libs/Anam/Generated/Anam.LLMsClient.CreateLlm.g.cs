...
namespace Anam
{
    public partial class LLMsClient
    {
        ...
        private static readonly global::Anam.EndPointSecurityRequirement s_CreateLlmSecurityRequirement0 =
        ...
        private static readonly global::Anam.EndPointSecurityRequirement[] s_CreateLlmSecurityRequirements =
            new global::Anam.EndPointSecurityRequirement[]
            {                s_CreateLlmSecurityRequirement0,
            };
        ...
        public async global::System.Threading.Tasks.Task<global::Anam.Llm> CreateLlmAsync(

            global::Anam.CreateLlmRequest request,
            global::Anam.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateLlmAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anam.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anam.AutoSDKHttpResponse<global::Anam.Llm>> CreateLlmAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Anam.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateLlmSecurityRequirements,
                operationName: "CreateLlmAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anam.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anam.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateLlmAsync",
                                pathTemplate: "\"/v1/llms\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Anam.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anam.Llm.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anam.AutoSDKHttpResponse<global::Anam.Llm>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anam.Llm.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Anam.Llm> CreateLlmAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anam.CreateLlmRequest
            {
