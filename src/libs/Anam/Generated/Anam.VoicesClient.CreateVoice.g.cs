...
namespace Anam
{
    public partial class VoicesClient
    {
        ...
        private static readonly global::Anam.EndPointSecurityRequirement s_CreateVoiceSecurityRequirement0 =
        ...
        private static readonly global::Anam.EndPointSecurityRequirement[] s_CreateVoiceSecurityRequirements =
            new global::Anam.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Anam.Voice> CreateVoiceAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anam.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anam.AutoSDKHttpResponse<global::Anam.Voice>> CreateVoiceAsResponseAsync(
                    ...
                    await global::Anam.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anam.Voice.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anam.AutoSDKHttpResponse<global::Anam.Voice>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anam.Voice.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Anam.Voice> CreateVoiceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anam.CreateVoiceRequest
            {
                Name = name,
                AudioFile = audioFile,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Anam.CreateVoiceRequest
            {
                Name = name,
                    ...
                    await global::Anam.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Anam.Voice.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Anam.Voice.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
