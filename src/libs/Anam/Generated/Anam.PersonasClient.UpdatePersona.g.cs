...
namespace Anam
{
    public partial class PersonasClient
    {
        ...
        {
            var __response = await UpdatePersonaAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anam.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anam.AutoSDKHttpResponse<global::Anam.PersonaConfig>> UpdatePersonaAsResponseAsync(
            string id,
