...
namespace Anam
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Anam.AutoSDKRetryOptions Retry { get; set; } = new global::Anam.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Anam.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Anam.IAutoSDKHook>();
        ...
        public global::Anam.AutoSDKClientOptions AddHook(
            global::Anam.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Anam.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Anam.AutoSDKClientOptions UseAuthorizationProvider(
            global::Anam.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Anam.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Anam.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Anam.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Anam.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Anam.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Anam.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Anam.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Anam.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Anam.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Anam.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Anam.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Anam.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Anam.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Anam.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Anam.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Anam.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Anam.AutoSDKClientOptions clientOptions,
            global::Anam.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Anam.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Anam.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Anam.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Anam.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Anam.IAutoSDKHook, global::Anam.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Anam.AutoSDKHookContext context)
        {
