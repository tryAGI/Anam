...
namespace Anam
{
    public partial class ShareLinksClient
    {
        ...
        private static readonly global::Anam.EndPointSecurityRequirement s_CreateShareLinkSecurityRequirement0 =
        ...
        private static readonly global::Anam.EndPointSecurityRequirement[] s_CreateShareLinkSecurityRequirements =
            new global::Anam.EndPointSecurityRequirement[]
            {                s_CreateShareLinkSecurityRequirement0,
            };
        partial void PrepareCreateShareLinkArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Anam.CreateShareLinkRequest request);
        partial void PrepareCreateShareLinkRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Anam.CreateShareLinkRequest request);
        partial void ProcessCreateShareLinkResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateShareLinkResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anam.ShareLink> CreateShareLinkAsync(

            global::Anam.CreateShareLinkRequest request,
            global::Anam.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateShareLinkAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anam.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anam.AutoSDKHttpResponse<global::Anam.ShareLink>> CreateShareLinkAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateShareLinkArguments(
            ...
            var __authorizations = global::Anam.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateShareLinkSecurityRequirements,
                operationName: "CreateShareLinkAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anam.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anam.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateShareLinkAsync",
                                pathTemplate: "\"/v1/share-links\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateShareLinkResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anam.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateShareLinkResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anam.ShareLink.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anam.AutoSDKHttpResponse<global::Anam.ShareLink>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anam.ShareLink.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Anam.ShareLink> CreateShareLinkAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anam.CreateShareLinkRequest
            {
                PersonaId = personaId,
            ...
            return await CreateShareLinkAsync(
                request: __request,
                requestOptions: requestOptions,
