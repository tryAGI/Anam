...
{
    private const string UserSecretsId = "Anam.CLI";
    private const string UserSecretApiKeyName = "ANAM_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"ANAM_API_KEY"];
    private const string CredentialFileDirectoryName = ".anam";

    public static async global::System.Threading.Tasks.Task<global::Anam.AnamClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Anam.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Anam.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Anam.AnamClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Anam.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Anam.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Anam.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Anam.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("ANAM_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Anam.ApiException exception)
    {
        var builder = new StringBuilder();
