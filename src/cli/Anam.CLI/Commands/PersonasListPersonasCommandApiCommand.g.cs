...
internal static partial class PersonasListPersonasCommandApiCommand
{
        ...
        name: @"--search")
    {
        Description = @"Filter personas by name.",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Anam.ListPersonasResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Anam.ListPersonasResponse value, ref string? text);
