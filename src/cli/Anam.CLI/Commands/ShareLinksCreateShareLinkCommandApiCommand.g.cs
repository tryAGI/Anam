...
internal static partial class ShareLinksCreateShareLinkCommandApiCommand
{
...
Create a new share link.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Anam.CreateShareLinkRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                        ...
                        var personaId = parseResult.GetRequiredValue(PersonaId);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ShareLinks.CreateShareLinkAsync(
                                    personaId: personaId,
